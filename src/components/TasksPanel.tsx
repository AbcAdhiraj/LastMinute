        ...
        <div className="lg:col-span-2 space-y-3">
          {tasks.length === 0 ? (
            ...
            tasks.map((task) => {
              ...
              let cardBgClass = 'bg-white border-2 border-black hover:bg-neutral-50 neo-shadow-black-sm';
              if (isSelected) {
                cardBgClass = 'bg-[#fffdd1] border-4 border-black neo-shadow-black';
              } else {
                if (task.category === 'career' || task.category === 'meeting') cardBgClass = 'bg-[#f5f3ff] hover:bg-[#ede9fe] border-2 border-black neo-shadow-black-sm';
                else if (task.category === 'study' || task.category === 'deep_work') cardBgClass = 'bg-[#f0f9ff] hover:bg-[#e0f2fe] border-2 border-black neo-shadow-black-sm';
                else if (task.category === 'health') cardBgClass = 'bg-[#f0fdf4] hover:bg-[#dcfce7] border-2 border-black neo-shadow-black-sm';
                else if (task.category === 'personal') cardBgClass = 'bg-[#fff1f2] hover:bg-[#ffe4e6] border-2 border-black neo-shadow-black-sm';
              }
              ...
              return (
                <div
                  ...
                  className={`p-4 rounded-xl transition-all duration-150 cursor-pointer ${cardBgClass}`}
                >
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="space-y-1">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {(() => {
                            let catBg = 'bg-white';
                            if (task.category === 'career' || task.category === 'meeting') catBg = 'bg-[#dfbeff]';
                            else if (task.category === 'study' || task.category === 'deep_work') catBg = 'bg-[#98e2ff]';
                            else if (task.category === 'health') catBg = 'bg-[#b8f598]';
                            else if (task.category === 'personal') catBg = 'bg-[#ff9ee1]';
                            return (
                              <span className={`text-[9px] ${catBg} border border-black px-1.5 py-0.5 rounded text-black font-mono font-black uppercase shadow-sm`}>
                                {task.category}
                              </span>
                            );
                          })()}
