  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 'm1',
      sender: 'assistant',
      text: "Hello Raj! I am Gemini, your Executive Assistant. I have audited your calendar, goals, and email commitments for June 2026. What should we organize today?",
      timestamp: new Date()
    }
  ]);
    ...
    <div className="flex flex-col h-[520px] bg-[#ffffff] border-4 border-black rounded-xl overflow-hidden text-xs neo-shadow-black">
       ...
       <div className="bg-[#b8f598] border-b-4 border-black px-5 py-3.5 flex items-center justify-between">
         <div className="flex items-center gap-2">
           ...
           <div>
             <h3 className="font-black text-[#000000] text-sm uppercase">Caly</h3>
             <p className="text-[10px] text-black/60 font-mono font-bold">College Study Copilot</p>
           </div>
         </div>
       </div>
