                ...
                {evts.length === 0 ? (
                  ...
                  <div className="relative border-l-2 border-black/80 ml-2 pl-4 space-y-3 font-mono text-[11px]">
                    {evts.map((e) => {
                      ...
                      if (e.category === 'meeting' || e.category === 'career') {
                        blockStyle = 'bg-[#dfbeff] border-2 border-black text-black'; // Purple for career/meeting
                      } else if (e.category === 'deep_work' || e.category === 'study') {
                        blockStyle = 'bg-[#98e2ff] border-2 border-black text-black'; // Blue for study/deep work
                      } else if (e.category === 'health') {
                        blockStyle = 'bg-[#b8f598] border-2 border-black text-black'; // Green for gym/health
                      } else if (e.category === 'personal') {
                        blockStyle = 'bg-[#ff9ee1] border-2 border-black text-black'; // Pink for dates/personal
                      } else if (e.category === 'commute') {
                        blockStyle = 'bg-[#ff9ee1]/30 border-2 border-dashed border-black text-black/80';
                      }
